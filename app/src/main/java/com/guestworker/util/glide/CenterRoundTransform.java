 ...
 * @author 莫小婷
 * @create 2018/11/28
 * @Describe 这个类是按照Glide的RoundedCornersTransformation书写的，为了能适配scaleType;
 */
public class CenterRoundTransform extends BitmapTransformation {
    ...
    public CenterRoundTransform(int radius, int margin) {
        this(radius, margin, CornerType.ALL);
    }

    public CenterRoundTransform(int radius, int margin, CornerType cornerType) {
        this.radius = radius;
    ...
    public boolean equals(Object o) {
        return o instanceof CenterRoundTransform &&
                ((CenterRoundTransform) o).radius == radius &&
                ((CenterRoundTransform) o).diameter == diameter &&
                ((CenterRoundTransform) o).margin == margin &&
                ((CenterRoundTransform) o).cornerType == cornerType;
    }
