        ...
        switch (v.getId()){
            ...
            case R.id.title_shareContainer:
                ...
                new ShareUtils(this, SHARE_MEDIA.WEIXIN)
                        .shareWeb(this, "https://developer.umeng.com/sdk", mDetailBean.getDefaultgoods().getGname(), mDetailBean.getDefaultgoods().getOverview(), RetrofitModule.IMG_URL + mDetailBean.getDefaultgoods().getThumbnail(), R.mipmap.logo);
                break;
