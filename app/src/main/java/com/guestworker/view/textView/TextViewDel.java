package com.guestworker.view.textView;
...
public class TextViewDel extends AppCompatTextView {
    ...
    private int mColor = R.color.color_959595;
    ...
    public void onDraw(Canvas canvas) {
        ...
        if (flag) {
            ...
            // 设置直线位置
            canvas.drawLine(0, this.getHeight() / 2 + ConvertUtils.dp2px(1), this.getWidth(), this.getHeight() / 2 + ConvertUtils.dp2px(1), paint);
        }
