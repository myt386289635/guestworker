...
//        //设置画笔颜色
        ...
        //设置文字大小
        selectPaint.setTextSize(ConvertUtils.sp2px(18));
...
//        //设置画笔颜色
        unSelectPaint.setColor(Color.rgb(158,148,146));

        //设置文字大小
        unSelectPaint.setTextSize(ConvertUtils.sp2px(16));
...
//        //设置画笔颜色
//        centerLinePaint.setColor(Color.rgb(102,203,255));
        centerLinePaint.setColor(ContextCompat.getColor(mContext, R.color.color_4D151515));
